...
{    
    ...
    for(i=0;i<13;i++){
        ...
        wHTML += ('<div angle="0" state="desktopView" style="visibility: visible; left: '+sleft+'px; top: '+stop+'px; width: ' + wWidth + '; height: ' + wHeight + ';margin:2px 2px 2px 2px; position: absolute; z-index: auto;background: C0D860;float:left">'+'<div>');
